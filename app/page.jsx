  ...
  <div>
    ...
    />
      ...
      <div className="flex justify-center bg-transparent" >
        <form className="absolute flex flex-wrap justify-center w-full gap-3 bg-transparent top-44">
        <input type="text" id="text" className="bg-gray-50 borde text-gray-900 text-lg rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Belanja Sayur" required />
